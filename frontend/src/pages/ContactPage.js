        ...
        <div className="main_box">
          <div className="sm_main_box">
            <div className="sm_box">
              <img src={Tg} alt="Balanced Meal" className="img_tg" />
            </div>
            <p>Telegram</p>
          </div>
          ...
          <div className="sm_main_box">
            <div className="sm_box">
              <img src={Vk} alt="Balanced Meal" className="img_tg" />
            </div>
            <p>VK</p>
          </div>
          ...
          <div className="sm_main_box">
            <div className="sm_box">
              <img src={Wp} alt="Balanced Meal" className="img_tg" />
            </div>
            <p>Whatsapp</p>
          </div>
          ...
          <div className="sm_main_box">
            <div className="sm_box">
              <img src={Yt} alt="Balanced Meal" className="img_tg" />
            </div>
            <p>YouTube</p>
          </div>
        </div>
